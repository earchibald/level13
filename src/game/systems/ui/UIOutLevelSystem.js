define([
	...
	var UIOutLevelSystem = Ash.System.extend({
		...
		SECTOR_MENU_BUILD_ROWS: [
			...
			{ id: "#out-action-improve-bucket", name: "Bucket+", fillID: "#out-collector-fill-water" },
			{ id: "#out-action-build-trap", name: "Trap" },
			{ id: "#out-action-improve-trap", name: "Trap+", fillID: "#out-collector-fill-food" },
		...
		SECTOR_MENU_ACTION_ROWS: [
			...
			{ id: "#out-action-use-trap", name: "Food (all)", fillID: "#out-collector-fill-food" },
			{ id: "#out-action-use-trap_one", name: "Food (1)", fillID: "#out-collector-fill-food" },
